...
public class MailSender {
     ...
     */
    public boolean sendTextMail(final HelpMailInfo mailInfo) {
     ...
     */
    public static boolean sendHtmlMail(HelpMailInfo mailInfo) {
        // 判断是否需要身份认证
        MyAuthenticator authenticator = null;
        Properties pro = mailInfo.getProperties();
        // 如果需要身份认证，则创建一个密码验证器
     ...
     * @return
     */
    public boolean sendFileMail(HelpMailInfo info, File file){
     ...
     * @return
     */
    private Message createAttachmentMail(final HelpMailInfo info, File file) {
        //创建邮件
